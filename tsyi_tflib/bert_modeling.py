...
from tsyi_tflib.utils import tf_utils

from tsyi_tflib.official.nlp.bert.bert_models import *

'''
from official.nlp.bert import bert_models 
get_transformer_encoder = bert_models.get_transformer_encoder
'''
...
def get_bert_model_new(input_word_ids,
                   input_mask,
                   input_type_ids,
                   config=None,
                   name=None,
  ...
  transformer_encoder = get_transformer_encoder(config, max_seq_length)
  
  # This model's have inputs=[input_word_ids, input_mask, input_type_ids], outputs=[sequence_output, cls_output(=pooled_output)])  
  bert_model = transformer_encoder
